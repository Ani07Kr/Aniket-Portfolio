...
export const Footer = () => {
  ...
  return (
    <footer className="border-t border-slate-200 dark:border-slate-800 bg-white/60 dark:bg-[#070A12]/80 backdrop-blur-lg pt-16 pb-20 sm:pb-12 transition-colors">
